...
| Hosting | Netlify / Vercel (planowana migracja) |
...
- Formularz rekrutacyjny dla nowych zawodników

---

## 📄 Licencja

Ten projekt jest udostępniony publicznie w celach edukacyjnych i portfolio. Kod źródłowy można przeglądać i wykorzystywać jako inspirację, natomiast marka, logo, dane zawodników i treści redakcyjne pozostają wyłączną własnością GKS Legsad Kościelec. Szczegóły w pliku [LICENSE](./LICENSE).
